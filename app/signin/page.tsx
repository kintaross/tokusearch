    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-50 to-brand-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">TokuSearch にログイン</h1>
          <p className="text-gray-600">
            お気に入りや保存したお得を端末間で同期できます
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-800 font-medium py-3 px-6 rounded-lg transition-colors"
          >
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          ログインするとお気に入り・保存リスト・メモが端末間で同期されます。
        </p>
      </div>
    </div>
  );
